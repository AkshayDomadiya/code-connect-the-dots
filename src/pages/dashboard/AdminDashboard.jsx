      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-8">
        ...
        <div className="xl:col-span-1">
          <Card className="shadow-lg h-full flex flex-col justify-between">
            ...
            <div className="border-t border-blue-gray-100 px-6 py-3">
            ...
            <Card className="shadow-lg">
              ...
              <CardBody className="pt-0 px-6 pb-6">
                <div className="text-center">
                  <div className="relative w-[40vw] h-[40vw] max-w-[240px] max-h-[240px] mx-auto mb-4">
                    <svg className="w-full h-full transform -rotate-90">
                      ...
                      <circle
                        ...
                        strokeWidth="8"
                        fill="none"
                        strokeDasharray={`${2.83 * 45} ${2.83 * 45 * (100 - 100) / 100}`}
                        strokeLinecap="round"
                      />
                    </svg>
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      <Typography variant="h3" className="font-bold text-blue-600 leading-tight">
                        0
                      </Typography>
